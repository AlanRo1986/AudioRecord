...
public class BytesTransUtil {
    ...
    public short getShort(byte[] buf, boolean bBigEnding) {
        if (buf == null) {
            throw new IllegalArgumentException("The param buf is null!");
        }
        if (buf.length > 2) {
            throw new IllegalArgumentException("The param buf size > 2!");
        }
        short r = 0;
        if (bBigEnding) {
            for (int i = 0; i < buf.length; i++) {
    ...
    public int getInt(byte[] buf, boolean bBigEnding) {
        ...
        if (buf.length > 4) {
            throw new IllegalArgumentException("The param buf size > 4!");
        }
    ...
    public long getLong(byte[] buf, boolean bBigEnding) {
        ...
        if (buf.length > 8) {
            throw new IllegalArgumentException("The param buf size > 8!");
        }
        long r = 0;
        if (bBigEnding) {
            for (int i = 0; i < buf.length; i++) {
